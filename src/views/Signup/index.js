...
export default () => {
    ...
    return (
        <Container>
            <Titulo>Olá Ponei!</Titulo>
            <SubTitulo color="neutral_0">Torne-se um Ponei agora mesmo e pegue caronas com outros estudantes para a sua universidade</SubTitulo>
            <InputArea>
                <IconInput
                    icon="human"
